        ...
        <div class="col-md-4 col-sm-12 card">
          <div class="card-body px-1 ">
            ...
            <div class="form-inline md-form form-sm mt-0">
              <a @click="searchRequest()"><i class="fa fa-search text-primary" aria-hidden="true"></i></a>
                        <input
              ...
              >
                        ...
                        <div class="content-history pr-2">
                          <span class="text-muted" v-if="lstRequestHistory.length>0">Tìm thấy <span class="font-weight-bold">{{lstRequestHistory.length}}</span> yêu cầu</span>
                            <div v-for=" req in lstRequestHistory" :key="req.id" :id="'item'+req.id" class="rounded p-1 card mb-3">
